...
namespace ProTelerikDemo.Web.Services
{
    ...
    public class NorthwindDomainService : LinqToEntitiesDomainService<NorthwindEntities>
    {
        ...
        public IQueryable<MonthlySales> GetMonthlySales()
        {
            return this.ObjectContext.MonthlySales1;
        }

        public IQueryable<Product> GetMostExpensiveProducts()
        {
            return this.ObjectContext.Products
        ...
        public IQueryable<Territory> GetTerritoriesByRegion(int RegionID)
        {
            return this.ObjectContext.Territories
        ...
        public EntityCollection<Employee> GetEmployeesByTerritory(string territory)
        {
            return this.ObjectContext.Territories
                                    .Include("Employees")
                                    .Where(t => t.TerritoryID == territory)
                                    .First()
                                    .Employees;
        }

        public IQueryable<Order> GetEmployeeOrders(int employeeId)
        {
            return this.ObjectContext.Orders
