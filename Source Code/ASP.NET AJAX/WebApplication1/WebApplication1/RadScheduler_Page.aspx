...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1>Databinding to a WebService</h1>
        <a href="RadScheduler_WS.aspx">Run Example</a>
    <br /><br />
    ...
    <br /><br />
    <h1>Client API</h1>
    <telerik:RadScheduler ID="RadScheduler9" runat="server" 
        DataDescriptionField="Description" DataEndField="End" DataKeyField="ID" 
        DataRecurrenceField="RecurrenceRule"
        DataRecurrenceParentKeyField="RecurrenceParentID"
        DataStartField="Start" DataSubjectField="Subject"
        OnClientTimeSlotClick="CreateAppointment"
        OnClientAppointmentClick="EditAppointment"
        OnClientAppointmentMoveEnd="AppointmentMoved">
    </telerik:RadScheduler>
    <script type="text/javascript">
        function CreateAppointment(sender, eventArgs) {
