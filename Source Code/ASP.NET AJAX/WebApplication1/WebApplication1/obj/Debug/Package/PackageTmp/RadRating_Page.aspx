...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" 
        ...
        <HeaderStyle Width="20px"></HeaderStyle>
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="Rating" UniqueName="TemplateColumn">
                    <ItemTemplate>
                        <telerik:RadRating ID="RadRating1" runat="server" Value='<%# Convert.ToDouble(Eval("AverageRating")) %>'
                            Precision="Half" />
                    </ItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:NorthwindConnectionString %>" 
        SelectCommand="SELECT [ProductID], [ProductName], [CategoryName], 0 as [AverageRating] FROM [Alphabetical list of products]">
    </asp:SqlDataSource>
</asp:Content>
