	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" class="reControlsLayout">
						...
						<table cellpadding="0" cellspacing="0" class="reConstrainProportionsWrapper">
							<tr>
								<td class="reLabelCell" style="width: 120px;">
									<label class="reDialogLabel" for="ImageWidth">
							...
							<tr>
								<td class="reLabelCell" style="width: 120px;">
									<label class="reDialogLabel" for="ImageHeight">
										<span style="text-align: right;">
				...
				<tr>
					<td class="reLabelCell" style="width: 120px;">
						<label class="reDialogLabel" for="ImageAlt">
							<span style="text-align: right;">
								<script type="text/javascript">
				...
				<tr id="thumbRow" runat="server" visible="false">
					<td colspan="2">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td style="width: 128px;">
									<label class="reDialogLabel" for="chkThumb">
										<span style="text-align: right;width:125px;">
							...
							<tr>
								<td style="width: 128px;">
									<label class="reDialogLabel" for="chkNewWindow">
										<span style="text-align: right;width:125px;">
