...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function ShowRadWindow1() {
            var wnd = $telerik.findWindow("<%=RadWindow1.ClientID %>");
    ...
    <script language="javascript" type="text/javascript">
        function ShowRadWindow2() {
            var wnd = $telerik.findWindow("<%=RadWindow2.ClientID %>");
            wnd.setUrl("http://www.cswsolutions.com");
            wnd.show();
        }
    </script>
    ...
    <script language="javascript" type="text/javascript">
        function ShowModalRadWindow() {
            var wnd = $telerik.findWindow("<%=RadWindow3.ClientID %>");
            wnd.setUrl("http://www.cswsolutions.com");
            wnd.set_modal(true);
            wnd.show();
        }
    ...
    <script language="javascript" type="text/javascript">
        function OpenProductsRadWindow() {
            var wnd = $telerik.findWindow("<%=ProductsRadWindow.ClientID %>");
    ...
    <script language="javascript" type="text/javascript">
        function ShowRadWindowM() {
            var wnd = $telerik.findWindow("<%=RadWindow4.ClientID %>");
